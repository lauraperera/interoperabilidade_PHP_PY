<?php
	...
	$sql = "
		...
		create view if not exists vvoo as select v.id, a.matricula || a.fabricante || a.modelo as aviao, o.iata origem, d.iata destino, v.datahora from voo v join aviao a on a.id = v.aviao join destino o on v.destino = o.id join destino d on v.destino = d.id; 
